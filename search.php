...
foreach ($results as $result) {
    if (stripos($result['name'], $search) !== false) {
        if (strcasecmp($result['name'], $search) == 0) {
            $exact_match[] = $result;
        } else {
            $partial_match[] = $result;
        }
    } elseif (stripos($result['description'], $search) !== false) {
        $description_match[] = $result;
    }
}

$sorted_results = array_merge($exact_match, $partial_match, $description_match);
